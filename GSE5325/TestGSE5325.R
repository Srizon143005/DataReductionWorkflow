...
data <- read.csv("F:/Thesis/New/Data/GSE5325/GSE5325_Classified.csv", row.names=1)
...
for (i in 1:nrow(data)){
  ...
  vec2 = as.numeric(data[i:i,46:105])
...
write.csv(res, file="F:/Thesis/New/Data/GSE5325/GSE5325_T_bonferroni_05_result_all.csv")
write.csv(res2, file="F:/Thesis/New/Data/GSE5325/GSE5325_T_bonferroni_05_result.csv")
